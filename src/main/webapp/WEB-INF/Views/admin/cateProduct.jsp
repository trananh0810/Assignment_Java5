...
<head>
    <meta charset="UTF-8">
    <title>Delicious | Admin - Danh mục sản phẩm</title>
    ...
    <div class="div-content">
        ...
        <div class="container-fluid div-content-center">
            <div class="row pt-4">
                ...
                <div class="col-sm-6">
                    <input type="text" class="form-control" name="" id="txt-search" placeholder="Tìm kiếm... ">
                </div>
                <div class="col-sm-3">
            ...
            <div class="row div-category-table mt-5">
                <div class="col-sm-3"></div>
                <div class="col-sm-6">
                    <table class="table table-bordered table-hover" id="tbl-cate-product">
                        ...
                        <c:set var="index" value="1"/>
                            <c:forEach var="item" items="${listCateProduct}">
                                <tr>
    ...
    <script>
        $(function(){
            $('#btn-addCategory, .btn-edit').click(function(){
                ...
                var url = contextPath + "/admin/cate/product/detail/" + id;
            ...
            $('.btn-delete').click(function () {
                ...
                var url = contextPath + "/ajax/admin/cate/product/delete";
                            ...
                            success: function (value) {
                                if (value == 'cannot_delete'){
                                    Swal.fire({
                                        position: 'top-end',
                                        type: 'warning',
                                        title: 'Không thể xóa Danh mục đã có Sản phẩm',
            ...
            $('#section2ContentId ul>a:nth-child(2)>li').css('color','#ef7147');

            $("#txt-search").on("keyup", function() {
                var value = $(this).val().toLowerCase();
                $("#tbl-cate-product tbody tr").filter(function() {
