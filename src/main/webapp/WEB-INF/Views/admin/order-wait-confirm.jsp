...
<head>
    <meta charset="UTF-8">
    <title>Delicious | Admin - Đơn hàng chờ xác nhận</title>
...
<body>
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer text-muted">
                                <div class="row text-center">
                                    <div class="col-sm-12">
                                        <a href="<c:url value="/admin/order/cancelOrder/${item.id}"/>">
                                            <div class="btn btn-danger">Hủy</div>
                                        </a>
                                        <a href="<c:url value="/admin/order/confirmOrder/${item.id}"/>">
                                            <div class="btn btn-success">Chấp nhận</div>
                                        </a>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        $(function () {
            ...
            $('#section4ContentId ul>a:nth-child(1)>li').css('color','#ef7147');
        })
    </script>
</body>
</html>