...
<head>
    <meta charset="UTF-8">
    <title>Delicious | Admin - Danh sách Sản phẩm</title>
    ...
    <div class="div-content">
        ...
        <div class="container-fluid div-content-center">
            <div class="row pt-4">
                ...
                <div class="col-sm-3">
                    <a href="<c:url value="/admin/product/-1"/>">
            ...
            <div class="row div-category-table mt-5">
                <!-- <div class="col-sm-3"></div> -->
                <div class="col-sm-12">
                    <table class="table table-bordered table-hover" id="tbl-listProduct">
                        ...
                        <c:set var="index" value="1"/>
                            <c:forEach var="item" items="${list_product}">
                                <tr>
                                    ...
                                    <td>${item.name}</td>
                                    <td class="text-center">${item.categoryProductByCategoryId.name}</td>
                                    <td class="text-center">
                                        <fmt:formatNumber pattern="#,000đ" value="${item.price}"/>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <a href="<c:url value="/admin/product/${item.id}"/>">
                                            <div class="btn btn-warning">
                                                Sửa
                                            </div>
                                        </a>

                                        <div class="btn btn-danger btn-delete-product"
    ...
    <script>
        $(function () {
            ...
            $("#txt-search").on("keyup", function() {
                ...
                $("#tbl-listProduct tbody tr").filter(function() {
            ...
            $('.btn-delete-product').click(function () {
                ...
                var url = contextPath + "/ajax/admin/product/delete";
